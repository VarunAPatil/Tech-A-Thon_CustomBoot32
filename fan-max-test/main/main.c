/*
 * fan-max-test: Fan runs at 100% PWM, DS18B20 temp is read and printed every second.
 *
 * Pinout:
 *   Fan PWM  → GPIO 7
...
void app_main(void)
{
    ...
    printf("\n=== FAN MAX TEST (100%% PWM) ===\n");
    printf("Fan GPIO : %d  |  Duty: %d/255 (100%%)\n", PWM_GPIO, FAN_DUTY);
